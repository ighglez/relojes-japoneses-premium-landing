...
const watches = [
  {
    ...
    reference: "SSC911P1",
    description: "Un homenaje contemporáneo a los cronógrafos clásicos de Seiko. Su esfera “panda”, con contraste blanco y subesferas negras, aporta elegancia deportiva y presencia atemporal. Equilibrio perfecto entre herencia y precisión moderna: movimiento automático 8R48 con rueda de pilares y embrague vertical. Una pieza con alma de competición, pensada para quienes valoran la historia.",
  ...
  },
  {
    ...
    reference: "SSK035K1",
    description: "Un GMT con carácter propio, reconocible al instante por su bisel verde y negro — conocido entre aficionados como el estilo “Sprite”. Combina un diseño versátil con la robustez de su movimiento automático 4R34 y función GMT para uso diario o viaje. Fiabilidad, personalidad y un punto de exclusividad que lo convierte en uno de los modelos más buscados de la colección.",
  ...
  },
  {
    ...
    name: "Seiko 5 Sports GMT",
    reference: "SSK001K1",
    description: "Elegancia y esencia en una de las combinaciones más apreciadas de la serie 5 Sports. El bisel negro y los detalles plateados —“estilo Bruce Wayne” entre coleccionistas— le dan un aire sofisticado y discreto. Movimiento automático 4R34, reserva de marcha de 41 horas y una ejecución impecable que refleja el equilibrio entre fiabilidad y diseño clásico.",
